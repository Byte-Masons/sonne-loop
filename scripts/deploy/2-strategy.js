...
async function main() {
  ...
  const soWant = '0x8cD6b19A07d754bF36AdEEE79EDF4F2134a8F571';

  const targetLtv = ethers.utils.parseEther('0.63');

  // const options = { gasPrice: 2000000000000, gasLimit: 9000000 };

  const strategy = await hre.upgrades.deployProxy(
    Strategy,
    [vaultAddress, treasuryAddress, [strategist1, strategist2, strategist3, strategist4], [superAdmin, admin, guardian] , soWant, targetLtv],
    { kind: 'uups' },
  );
